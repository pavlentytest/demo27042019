...
namespace App.test2DataSetTableAdapters {
...
SELECT ID, Артикул, Наименование, Ширина, Длина, Тип, Цена FROM furniture WHERE (ID = @ID)";
        ...
        public virtual int Fill(test2DataSet.furnitureDataTable dataTable) {
        ...
        public virtual test2DataSet.furnitureDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            test2DataSet.furnitureDataTable dataTable = new test2DataSet.furnitureDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(test2DataSet.furnitureDataTable dataTable) {
